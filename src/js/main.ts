...
const addTask = document.getElementById("add-btn") as HTMLButtonElement;
const modalTask = document.getElementById("modal-overlay") as HTMLDivElement;
const closeModal = document.getElementById("close-modal-btn") as HTMLButtonElement;
const cancelModal = document.getElementById("cancel-btn") as HTMLButtonElement;
...
const tasksProgress = document.getElementById("tasks-in-progress") as HTMLDivElement;
const tasksCompleted = document.getElementById("tasks-completed") as HTMLDivElement;
const todoCountElement = document.getElementById("todo-count") as HTMLParagraphElement;
const progressCountElement = document.getElementById("progress-count") as HTMLParagraphElement;
const completedCountElement = document.getElementById("completed-count") as HTMLParagraphElement;
let data: Task[] = [];
// open and close
...
// submit
taskForm.addEventListener("submit", function (e: SubmitEvent): void {
    e.preventDefault();
    if (checkInput() === false) {
        return;
    }
...
function displayData() : void {
  let todoCartoona: string = "";
  let progressCartoona: string = "";
...
const editBtn = document.querySelectorAll(".edit-btn") as NodeListOf<HTMLButtonElement>;
const submitttBtn = document.getElementById("submittt-btn") as HTMLButtonElement;
...
displayData();
// keydown
taskForm.addEventListener("keydown", (e: KeyboardEvent) => {
    if (e.key === "Enter") {
        e.preventDefault();
